---
title: "Introduction to mark-recapture - estimating abundance"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: false
...
> Copy the code needed to simulate the L-P data (the code from the `chapman` chunk in the homework file)  
...
Follow the [instructions for submission](https://rushinglab.github.io/WILD3810/articles/homework.html) to upload your completed assignment to Canvas
