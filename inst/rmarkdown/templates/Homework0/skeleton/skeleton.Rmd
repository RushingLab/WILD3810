...
**Due before 2:30pm Monday January 13**
...
> 10a) In the space below, type "I completed this assignment on " and then include a inline code that prints the `date` object you created in the chunk above
