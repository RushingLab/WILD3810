...
Collared-dove - predict using D-I model, 

## Estimating $\lambda$ or other paramters from counts 

estimate growth paramters for logistic model based on other state data, 
