.onLoad <- function(libname="WILD3810", pkgname="WILD3810") {
  ...
  theme_spacelab <- function(base_size = 12, base_family = "") {
    ...
    theme(
      ...
      axis.title = element_text(color = "grey30", vjust = 0.35),
  ...
  WILD3810_palette <- c("#446E9B", "#D47500", "#3CB521", "#CD0200", "#3399F3")
  assign("scale_colour_discrete", function(..., values = WILD3810_palette) scale_colour_manual(..., values = values), globalenv())
  assign("scale_fill_discrete", function(..., values = WILD3810_palette) scale_fill_manual(..., values = values), globalenv())
