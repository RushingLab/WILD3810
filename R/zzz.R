.onLoad <- function(libname="WILD3810", pkgname="WILD3810") {
  ...
  theme_slate <- function(base_size = 12, base_family = "") {
    ...
    theme(
      ...
      axis.text = element_text(size = rel(0.8), color = "#7a8288"),
      axis.title = element_text(size = rel(0.8), color = "#7a8288", vjust = 0.35),
      strip.text = element_text(size = rel(0.8)),

      axis.line = element_line(size = 0.8, color = "#7a8288"),
      axis.line.x = NULL,
      axis.line.y = NULL,
      ...
      axis.ticks = element_line(size = 0.2, color = "#7a8288"),
      ...
      legend.background = element_rect(colour = NA, fill = "#272B30"),
      ...
      legend.key = element_rect(colour = "#7a8288", fill = "#272B30"),
      legend.key.size = grid::unit(1.2, "lines"),
      legend.key.height = NULL,
      legend.key.width = NULL,
      legend.text = element_text(size = base_size, color = "#7a8288"),
      ...
      strip.background = element_rect(fill = "#272B30", colour = NA),
      strip.text.x = element_text(size = base_size * 1.6, margin = margin(t = half_line, b = half_line), face = "bold", color = "#7a8288"),
      strip.text.y = element_text(size = base_size * 1.6, angle = -90, margin = margin(l = half_line, r = half_line), face = "bold", color = "#7a8288"),
      ...
      plot.subtitle = element_text(color = "#7A8288",
        size = base_size * 1.2, hjust = 0,
        vjust = 2, margin = margin(b = half_line * 0.9)
      ),
      plot.caption = element_text(color = "#7A8288",
