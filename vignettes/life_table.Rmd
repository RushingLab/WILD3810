---
title: "Lab 4: Creating and interpreting a life table"
...
5) Name the project `life_table` and create it within your `WILD3810` folder (click `Browse` and navigate to this folder if necessary)
...
8) Select `From Template`; scroll down and select `WILD3810-Homework4`

```{r out.width="100%", echo=FALSE}
knitr::include_graphics("figs/from_template.png")
```

9) In the `Name` box, type `LastnameFirstName-Homework4`
...
**Note**: You will use the homework 4 template to complete the rest of this lab activity. You can copy the code below to your assignment template to start the assignment. However, you **do not** need to copy code the prints objects, only the code the creates or manipulates the objects.
