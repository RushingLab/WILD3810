...
The document we are going to create will form the basis of your first homework assignment so to start off the semster in an organized fashion, let's create a project called `WILD3810`:

0a) Click on `File -> New Project` then click `New Directory`

0b) Click `New Project`. Name this project `WILD3810` and choose a sensible location for the project (e.g., `Desktop/`)
...
1c) Scroll down through the options until you see `WILD3810-Homework1`. Select that template 

1d) In the `Name:` window type `LastnameFirstname-homework1`, substituting your last and first names. In the `Location` window, navigate to your newly create `LastNameFirstName-Homework1` directory
...
* RStudio will create a new file called `LastnameFirstname-homework1.pdf` - you should see that file in the `Files` window in the bottom right of your screen
