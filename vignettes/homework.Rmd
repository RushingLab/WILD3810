...
All homework assignments for this course will be completed R Markdown files. To make the distribution, completion, and grading easier, each homework will follow the same workflow. Detailed instructions for creating and submitting homeworks assignments depend on whether you are using RStudio Cloud or a local installation of RStudio:
