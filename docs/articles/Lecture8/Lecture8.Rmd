...
- $\Large T_x$: Area under the survival curve from age $x$ onward = $\sum_x^{max(x)}L_x$
...
#### Utah has the lowest per capita crude death rate d in the U.S. (averaged across all ages)
