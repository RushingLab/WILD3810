...
--
Probability distributions characterize the frequency of different possible outcomes $^4$  
...
Now `r mean(Nd$N[Nd$t==30] < 10)*100`% of the populations decreased and `r mean(apply(N, 1, min)==0)*100` went extinct $^7$ 
