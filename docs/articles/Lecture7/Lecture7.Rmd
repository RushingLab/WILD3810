...
Remember from the last lecture that, over a long enough time scales, the fate of any population that is subject to stochasticity is extinction  
...
We also learned that stochasticity, particularly demographic stochasticity, is most consequential at small population sizes  
...
In addition to demographic and environmental stochasticity, **genetic stochasticity** can also increase extinction risk for small populations  
<br/>  
...
As populations decrease in size, they reach a point where environmental stochasticity, demographic stochasticity, and genetic stochasticity all interact to drive populations towards extinction, the so called **extinction vortex**  
...
--
+ Historical population size (use Wood Thrush)?  

--
+ Other species (Rare and stable vs. common and declining)?  

--
+ Management standards (duck vs. cougar)? 


---
## What is a "small" population?

There is a long history of trying to define abundance thresholds that can be used to trigger management actions (*minimum viable population*):
...
--
However, due to the complex and interacting factors that determine exinctition risk, these criteria are often too simple to accurately assess true risk of exinction   
<br/>
...
> use data and models to estimate the likelihoods of a population crossing thresholds of vaibility within various time spans, and to give insights into factors that constitute the biggest threats $^1$  
...
- In the most simple cases, a viable means not extinct $(N > 0)$   


--
Usually, we not only want to prevent extinction, we also want keep abundance above some level where, e.g.
...
--
One of the central issues with any type of prediction is that predictions are less certain the farther in the future we try to project  
...
Most PVAs therefore incorporate both short-term and long-term objectives  
