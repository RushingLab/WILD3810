...
Figure from Powell 2015 "Estimation of Parameters for Animal Populations", pg 171
...
<br/>
If $\hat{P}_d = 1$, we detect every individual in our sampling area   
<br/>
<br/>
...
<br/>
2) Choose a black line on the side of the cup and remove all beans above that line
+ Each line is about 20% of the cups volume  
<br/>


3) Count and record the number of beans you removed  
<br/>
4) Estimate $\hat{N}$  
<br/>
5) Return all of the beans to the cup
...
<br/>
2) Remove a handful of beans from cup and count  
<br/>
3) Record how many beans you removed (call this $n_1$)  
<br/>
4) Count the same number of black beans and put them back in the cup (these are your marked individuals)  
<br/>
5) Cover and shake the cup
...
--
How can we make this assumption? Usually by conducting our sampling within a short $^{11}$ period of time  
...
<br/>
3) Count and record the number of black beans in the sample (this is $m_2$)  
<br/>
